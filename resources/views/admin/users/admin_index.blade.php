...
<div class="bg-white rounded shadow-sm border border-gray-100 mt-6 relative z-30 overflow-hidden">
    ...
    <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-white">
        <div>
            <h2 class="text-[17px] font-bold text-[#1f2937] capitalize">Admin Accounts Table</h2>
            <p class="text-[13px] text-gray-500 mt-1">
                Add, delete, update <span class="text-pink-500 font-medium">.admin-accounts</span>
                <br>
                <span class="text-gray-400">p.s password 4 character of email and nomor.</span>
            </p>
        </div>
        <div class="flex gap-3">
            <a href="{{ route('admin.users.export', ['role' => 'admin']) }}" class="flex items-center gap-2 bg-[#8b5cf6] hover:bg-violet-600 transition-colors text-white px-5 py-2.5 rounded text-[13px] font-semibold">
                Export Excel
            </a>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-5 text-center flex justify-center gap-2">
                        ...
                        <a href="{{ route('admin.users.edit', $user->id) }}" class="inline-block bg-[#8b5cf6] hover:bg-violet-600 text-white text-[13px] font-medium px-5 py-2 rounded transition-colors shadow-sm">
                            Edit
                        </a>
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-6 py-8 text-center text-gray-500">Tidak ada data akun admin.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
